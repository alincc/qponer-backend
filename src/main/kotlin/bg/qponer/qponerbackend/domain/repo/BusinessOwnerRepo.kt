...
interface BusinessOwnerRepo
    ...
    @Query("select new bg.qponer.qponerbackend.domain.dto.RankedContributor(concat(v.contributor.firstName, concat(' ', v.contributor.lastName)) , v.allTimeValue) from AccumulatedValue v " +
